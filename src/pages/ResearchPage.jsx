                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        {researchStats.map((stat, index) => (
                            <motion.div
                                ...
                                className="text-center p-6 rounded-lg bg-gray-50 hover:bg-blue-50 transition-colors duration-300"
                            >
                                <div className="text-3xl font-bold text-[#03a0a2] mb-2">{stat.number}</div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {researchAreas.map((area, index) => (
                            ...
                            >
                                ...
                                <motion.button
                                    whileHover={{ x: 5 }}
                                    className="text-[#03a0a2] font-semibold hover:text-[#7DF9FF] transition-colors"
                                >
                                    Learn More →
                                </motion.button>
                            </motion.div>
                    ...
                    <div className="space-y-8">
                        {publications.map((publication, index) => (
                            <motion.div
                                ...
                                className="bg-gray-50 rounded-lg p-6 border-l-4 border-[#7DF9FF] hover:shadow-lg transition-all duration-300"
                            >
