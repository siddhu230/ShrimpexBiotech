...
const HomePage = () => {
  ...
  return (
    ...
    >
      ...
      <section className="py-20 bg-gradient-to-br from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          >
            ...
            <span className="gradient-text">Diagnostics</span> and{' '}
          ...
          >
            Pioneering biotechnology solutions in human molecular diagnostics
          </motion.p>
          ...
          >
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                to="/services"
                className="hero-btn  text-white px-8 py-3 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 inline-block"
              >
                Human Diagnostics
              </Link>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-16">
              {[
                ...
                >
                  ...
                  <Link
                    to={item.link}
                    className="text-[#03a0a2] font-semibold hover:text-[#7DF9FF] transition-colors duration-300"
                  >
                    Learn More →
                  </Link>
                </motion.div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#7DF9FF] to-[#03a0a2]">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <motion.div
          ...
          >
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              <Link
                to="/contact"
                className="bg-white text-[#03a0a2] hover:bg-gray-100 px-8 py-4 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
              >
                Get Started Today
              </Link>
              <Link
                to="/services"
                className="border-2 border-white text-white hover:bg-white hover:text-[#03a0a2] px-8 py-4 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105"
              >
