                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {resourceCategories.map((category, index) => (
                            ...
                            >
                                ...
                                <div className="text-sm font-semibold text-[#03a0a2]">{category.count}</div>
                            </motion.div>
                        ))}
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid md:grid-cols-2 gap-12">
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                        >
                            <h3 className="text-2xl font-bold text-[#03a0a2] mb-8">Downloadable Resources</h3>
                            <div className="space-y-4">
                                {downloadableResources.map((resource, index) => (
                                    <motion.div
                                        ...
                                        className="flex items-center p-4 bg-white hover:bg-blue-50 rounded-lg border border-gray-200 hover:border-[#7DF9FF] transition-all duration-300 cursor-pointer"
                                    >
                                        <div className="text-[#03a0a2] mr-4">
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                        >
                            <h3 className="text-2xl font-bold text-[#03a0a2] mb-8">Latest Articles</h3>
                            <div className="space-y-6">
                                {articles.map((article, index) => (
                                    <motion.div
                                        ...
                                        className="bg-white rounded-lg p-6 border border-gray-200 hover:border-[#7DF9FF] hover:shadow-lg transition-all duration-300"
                                    >
                                        <div className="flex items-start justify-between mb-3">
                                            <span className="inline-block px-3 py-1 bg-blue-100 text-[#03a0a2] text-sm font-medium rounded-full">
                                                {article.category}
                                            </span>
                                            <ExternalLink size={16} className="text-gray-400" />
                                        </div>
                                        <h4 className="text-xl font-bold text-gray-900 mb-3 hover:text-[#03a0a2] transition-colors">
                                            {article.title}
                                        </h4>
                ...
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    >
                        <input
                            ...
                            className="flex-grow px-4 py-3 rounded-lg border border-gray-300 focus:border-[#03a0a2] focus:ring-2 focus:ring-[#03a0a2] focus:ring-opacity-30 outline-none"
                        />
                        <motion.button
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className="bg-[#03a0a2] hover:bg-[#7DF9FF] text-white px-6 py-3 rounded-lg font-semibold transition-all duration-300"
                        >
                            Subscribe
                        </motion.button>
                    </motion.div>
