                        ...
                        {tabs.map((tab) => (
                            <motion.button
                                ...
                                className={`px-8 py-3 rounded-lg font-semibold transition-all duration-300 ${activeTab === tab.id
                                        ? 'bg-[#03a0a2] text-white shadow-lg'
                                        : 'bg-white text-gray-600 border border-gray-300 hover:border-[#7DF9FF]'
                                    }`}
                            >
                                {tab.name}
                            </motion.button>
                            ...
                            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                                {services[activeTab].map((service, index) => (
                                    <motion.div
                                        ...
                                        className="service-card bg-white rounded-2xl p-6 border border-gray-200 hover:border-[#03a0a2] transition-all duration-300 hover:shadow-xl"
                                    >
                                        <motion.div
                ...
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-4 gap-8">
                        {[
                            ...
                            >
                                <motion.div
                                    className="w-16 h-16 bg-[#03a0a2] text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4"
                                    whileHover={{
                                        scale: 1.1,
                                        rotate: 360,
                                        transition: { duration: 0.6 }
