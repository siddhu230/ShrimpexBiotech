...
const ContactPage = () => {
    ...
    const contactInfo = [
        {
            icon: MapPin,
            title: "Address",
            details: "6 & 7, VGP Uthandi Layout Part II, Gandhi Street, SH 49, Uthandi, Chennai, Tamil Nadu 600119",
            color: "text-blue-600"
        },
        {
            icon: Phone,
            title: "Phone",
            details: "+91-8754579246",
            color: "text-green-600"
        },
        {
            icon: Mail,
            title: "Email",
            details: "infoshrimpexbio@gmail.com",
    ...
    return (
        ...
        >
            {/* Hero Section */}
            <AnimatedSection className="py-20 bg-gradient-to-br from-white to-gray-200">
            ...
            {/* Contact Content */}
            <AnimatedSection className="py-20 bg-gray-50 bg-gradient-to-tr from-white to-gray-200">
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className="mt-8 p-6 bg-blue-50 rounded-lg border border-[#7DF9FF]"
                            >
                                <h3 className="text-xl font-bold text-[#03a0a2] mb-3">Why Choose Us?</h3>
                        ...
                        >
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    className={`w-full bg-[#03a0a2] hover:bg-[#7DF9FF] text-white py-3 px-6 rounded-lg font-semibold transition-all duration-300 ${isSubmitting ? 'opacity-75 cursor-not-allowed' : 'transform hover:scale-105'
                                        }`}
                                >
                                    {isSubmitting ? (
