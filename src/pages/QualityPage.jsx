        ...
        >
            ...
            <AnimatedSection className="py-20 bg-gradient-to-br from-white to-gray-50">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <motion.h1
                        ...
                        className="text-4xl md:text-5xl pb-2 font-bold mb-6 gradient-text"
                    >
                        Quality & Compliance
                    </motion.h1>
                    <motion.p
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {certifications.map((cert, index) => (
                            <motion.div
                                ...
                                className="bg-white rounded-2xl p-6 text-center border border-gray-200 hover:border-[#03a0a2] transition-all duration-300 hover:shadow-xl"
                            >
                                <motion.div
                                    initial={{ scale: 0 }}
                                    whileInView={{ scale: 1 }}
                ...
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {qualityPillars.map((pillar, index) => (
                            ...
                            >
                                <h3 className="text-2xl font-bold text-[#03a0a2] mb-4">{pillar.title}</h3>
                                ...
                                <ul className="space-y-3">
                                    {pillar.points.map((point, pointIndex) => (
                                        ...
                                        >
                                            <CheckCircle size={16} className="text-[#03a0a2] mr-3 mt-0.5 flex-shrink-0" />
                                            {point}
                                        </motion.li>
                                    ))}
                                </ul>
            ...
            <AnimatedSection className="py-20 bg-blue-50">
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    >
                        <h3 className="text-2xl font-bold text-[#03a0a2] mb-4">Regulatory Compliance</h3>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-4 gap-8">
                        {[
                            ...
                            >
                                <div className="text-3xl font-bold text-[#03a0a2] mb-2">{metric.metric}</div>
            ...
            {/* CTA Section */}
            <AnimatedSection className="py-20 bg-gradient-to-r from-[#7DF9FF] to-[#03a0a2]">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <motion.h2
                        initial={{ opacity: 0, scale: 0.9 }}
                        whileInView={{ opacity: 1, scale: 1 }}
                    ...
                    >
                        <motion.a
                            ...
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className="bg-white text-[#03a0a2] hover:bg-gray-100 px-8 py-4 rounded-lg font-semibold transition-all duration-300 inline-block"
                        >
